...
\begin{description}
	...
	thus preventing Sybil attacks~\cite{douceur2002sybil} and double-voting
...
\begin{itemize}
	...
	complexity $O(t)$ \cite{pease1980reaching} and using a probabilistic
	...
	a public-key infrastructure (PKI) \cite{pease1980reaching}.
\end{itemize}
...
\begin{description}
	...
	to MPC. For example, BA is impossible for any $t\geq n/3$ \cite{pease1980reaching},
